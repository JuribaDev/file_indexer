...
import 'package:file_indexer/src/command_runner.dart';
...
void main() {
  group('FileIndexerCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FileIndexerCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FileIndexerCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FileIndexerCommandRunner();
